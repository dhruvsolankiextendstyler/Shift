...
class AnimatedGlassIndicator extends StatelessWidget {
  ...
  /// **AttendEase patch.** Forwarded to
  /// [DraggableIndicatorPhysics.buildJellyTransform] so the pill elongates
  /// along its direction of travel rather than squashing across it. Defaults
        ...
        Positioned.fromRelativeRect(
          ...
          child: Transform(
            ...
            transform: DraggableIndicatorPhysics.buildJellyTransform(
              ...
              maxDistortion: 0.8,
              velocityScale: 10,
              // AttendEase patch: threaded from the hosting bar, default false.
              stretchAlongMotion: stretchAlongMotion,
            ),
            child: glassChild,
          ),
        ),
